...
plot_convergence "cos(2 * pi * x)" "sin(2 * pi * x)" --dt "dx**2" --theta 1.0 --final_time 1. --max_grid 9 --method "forward" --tag "_fig2"
...
plot_convergence "cos(2 * pi * x)" "sin(2 * pi * x)" --dt "dx / sqrt(g * H)" --theta 1.0 --final_time 1. --max_grid 14 --tag "_fig5"

## Figure 6
echo "Figure 6: Plotting stability of forward-backward"
plot_stability_sweep "cos(2 * pi * x)" "sin(2 * pi * x)" --theta 1.0 --final_time 1. --beta_start 1.5 --beta_end 2.1 --beta_steps 100 --tag "_fig6"

## Figure 7
echo "Figure 7: Plotting convergence comparison"
plot_comparison "cos(2 * pi * x)" "sin(2 * pi * x)" --dt "dx**2" --theta 1.0 --final_time 1. --max_grid 9 --tag "_fig7"
